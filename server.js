...
app.use((req, res, next) => {
  ...
  res.setHeader(
    ...
    [
      "default-src 'self'",
      "script-src 'self' 'unsafe-eval' 'wasm-unsafe-eval' https://cdn.tailwindcss.com https://unpkg.com https://cdn.jsdelivr.net",
      "script-src-elem 'self' https://cdn.tailwindcss.com https://unpkg.com https://cdn.jsdelivr.net",
      "script-src-attr 'unsafe-inline'",
      "style-src 'self' 'unsafe-inline'",
      "img-src 'self' data:",
      "connect-src 'self' https://huggingface.co https://*.huggingface.co https://*.hf.co https://*.xethub.hf.co https://unpkg.com https://cdn.jsdelivr.net",
